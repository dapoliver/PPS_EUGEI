...
rf_results <- data.frame(model=c("PPS", "PRS", "All"),
                         C=c(paste0(round(mean(results_PPS$c_stat_nested$C),2), " (",
                                    round(mean(results_PPS$c_stat_nested$C) - sd(results_PPS$c_stat_nested$C) / sqrt(nrow(results_PPS$c_stat_nested)),2),
                                    "-",
                                    round(mean(results_PPS$c_stat_nested$C) + sd(results_PPS$c_stat_nested$C) / sqrt(nrow(results_PPS$c_stat_nested)),2),
                                    ")"),
                             paste0(round(mean(results_genes$c_stat_nested$C),2), " (",
                                    round(mean(results_genes$c_stat_nested$C) - sd(results_genes$c_stat_nested$C) / sqrt(nrow(results_genes$c_stat_nested)),2),
                                    "-",
                                    round(mean(results_genes$c_stat_nested$C) + sd(results_genes$c_stat_nested$C) / sqrt(nrow(results_genes$c_stat_nested)),2),
                                    ")"),
                             paste0(round(mean(results_all$c_stat_nested$C),2), " (",
                                    round(mean(results_all$c_stat_nested$C) - sd(results_all$c_stat_nested$C) / sqrt(nrow(results_all$c_stat_nested)),2),
                                    "-",
                                    round(mean(results_all$c_stat_nested$C) + sd(results_all$c_stat_nested$C) / sqrt(nrow(results_all$c_stat_nested)),2),
                                    ")")),
                         BAC=c(paste0(round(mean(results_PPS$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                      round((mean(results_PPS$c_stat_nested$balanced_accuracy) - sd(results_PPS$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS$c_stat_nested)))*100,1),
                                      "%-",
                                      round((mean(results_PPS$c_stat_nested$balanced_accuracy) + sd(results_PPS$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS$c_stat_nested)))*100,1),
                                      "%)"),
                               paste0(round(mean(results_genes$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                      round((mean(results_genes$c_stat_nested$balanced_accuracy) - sd(results_genes$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_genes$c_stat_nested)))*100,1),
                                      "%-",
                                      round((mean(results_genes$c_stat_nested$balanced_accuracy) + sd(results_genes$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_genes$c_stat_nested)))*100,1),
                                      "%)"),
                               paste0(round(mean(results_all$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                      round((mean(results_all$c_stat_nested$balanced_accuracy) - sd(results_all$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_all$c_stat_nested)))*100,1),
                                      "%-",
                                      round((mean(results_all$c_stat_nested$balanced_accuracy) + sd(results_all$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_all$c_stat_nested)))*100,1),
                                      "%)")),
                         sensitivity=c(paste0(round(mean(results_PPS$c_stat_nested$sensitivity)*100,1), "% (",
                                      round((mean(results_PPS$c_stat_nested$sensitivity) - sd(results_PPS$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS$c_stat_nested)))*100,1),
                                      "%-",
                                      round((mean(results_PPS$c_stat_nested$sensitivity) + sd(results_PPS$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS$c_stat_nested)))*100,1),
                                      "%)"),
                               paste0(round(mean(results_genes$c_stat_nested$sensitivity)*100,1), "% (",
                                      round((mean(results_genes$c_stat_nested$sensitivity) - sd(results_genes$c_stat_nested$sensitivity) / sqrt(nrow(results_genes$c_stat_nested)))*100,1),
                                      "%-",
                                      round((mean(results_genes$c_stat_nested$sensitivity) + sd(results_genes$c_stat_nested$sensitivity) / sqrt(nrow(results_genes$c_stat_nested)))*100,1),
                                      "%)"),
                               paste0(round(mean(results_all$c_stat_nested$sensitivity)*100,1), "% (",
                                      round((mean(results_all$c_stat_nested$sensitivity) - sd(results_all$c_stat_nested$sensitivity) / sqrt(nrow(results_all$c_stat_nested)))*100,1),
                                      "%-",
                                      round((mean(results_all$c_stat_nested$sensitivity) + sd(results_all$c_stat_nested$sensitivity) / sqrt(nrow(results_all$c_stat_nested)))*100,1),
                                      "%)")),
                         specificity=c(paste0(round(mean(results_PPS$c_stat_nested$specificity)*100,1), "% (",
                                              round((mean(results_PPS$c_stat_nested$specificity) - sd(results_PPS$c_stat_nested$specificity) / sqrt(nrow(results_PPS$c_stat_nested)))*100,1),
                                              "%-",
                                              round((mean(results_PPS$c_stat_nested$specificity) + sd(results_PPS$c_stat_nested$specificity) / sqrt(nrow(results_PPS$c_stat_nested)))*100,1),
                                              "%)"),
                                       paste0(round(mean(results_genes$c_stat_nested$specificity)*100,1), "% (",
                                              round((mean(results_genes$c_stat_nested$specificity) - sd(results_genes$c_stat_nested$specificity) / sqrt(nrow(results_genes$c_stat_nested)))*100,1),
                                              "%-",
                                              round((mean(results_genes$c_stat_nested$specificity) + sd(results_genes$c_stat_nested$specificity) / sqrt(nrow(results_genes$c_stat_nested)))*100,1),
                                              "%)"),
                                       paste0(round(mean(results_all$c_stat_nested$specificity)*100,1), "% (",
                                              round((mean(results_all$c_stat_nested$specificity) - sd(results_all$c_stat_nested$specificity) / sqrt(nrow(results_all$c_stat_nested)))*100,1),
                                              "%-",
                                              round((mean(results_all$c_stat_nested$specificity) + sd(results_all$c_stat_nested$specificity) / sqrt(nrow(results_all$c_stat_nested)))*100,1),
                                              "%)")),
...
rf_surv_results <- data.frame(model=c("Clinical", "PPS", "PRS", "Clinical+PPS", "Clinical+PRS", "PPS+PRS", "All"),
                         C=c(paste0(round(mean(results_clin_surv$c_stat_nested$C),2), " (",
                                    round(mean(results_clin_surv$c_stat_nested$C) - sd(results_clin_surv$c_stat_nested$C) / sqrt(nrow(results_clin_surv$c_stat_nested)),2),
                                    "-",
                                    round(mean(results_clin_surv$c_stat_nested$C) + sd(results_clin_surv$c_stat_nested$C) / sqrt(nrow(results_clin_surv$c_stat_nested)),2),
                                    ")"),
                             paste0(round(mean(results_PPS_surv$c_stat_nested$C),2), " (",
                                    round(mean(results_PPS_surv$c_stat_nested$C) - sd(results_PPS_surv$c_stat_nested$C) / sqrt(nrow(results_PPS_surv$c_stat_nested)),2),
                                    "-",
                                    round(mean(results_PPS_surv$c_stat_nested$C) + sd(results_PPS_surv$c_stat_nested$C) / sqrt(nrow(results_PPS_surv$c_stat_nested)),2),
                                    ")"),
                             paste0(round(mean(results_PRS_surv$c_stat_nested$C),2), " (",
                                    round(mean(results_PRS_surv$c_stat_nested$C) - sd(results_PRS_surv$c_stat_nested$C) / sqrt(nrow(results_PRS_surv$c_stat_nested)),2),
                                    "-",
                                    round(mean(results_PRS_surv$c_stat_nested$C) + sd(results_PRS_surv$c_stat_nested$C) / sqrt(nrow(results_PRS_surv$c_stat_nested)),2),
                                    ")"),
                             paste0(round(mean(results_PPS_clin_surv$c_stat_nested$C),2), " (",
                                    round(mean(results_PPS_clin_surv$c_stat_nested$C) - sd(results_PPS_clin_surv$c_stat_nested$C) / sqrt(nrow(results_PPS_clin_surv$c_stat_nested)),2),
                                    "-",
                                    round(mean(results_PPS_clin_surv$c_stat_nested$C) + sd(results_PPS_clin_surv$c_stat_nested$C) / sqrt(nrow(results_PPS_clin_surv$c_stat_nested)),2),
                                    ")"),
                             paste0(round(mean(results_PRS_clin_surv$c_stat_nested$C),2), " (",
                                    round(mean(results_PRS_clin_surv$c_stat_nested$C) - sd(results_PRS_clin_surv$c_stat_nested$C) / sqrt(nrow(results_PRS_clin_surv$c_stat_nested)),2),
                                    "-",
                                    round(mean(results_PRS_clin_surv$c_stat_nested$C) + sd(results_PRS_clin_surv$c_stat_nested$C) / sqrt(nrow(results_PRS_clin_surv$c_stat_nested)),2),
                                    ")"),
                             paste0(round(mean(results_PPS_PRS_clin_surv$c_stat_nested$C),2), " (",
                                    round(mean(results_PPS_PRS_clin_surv$c_stat_nested$C) - sd(results_PPS_PRS_clin_surv$c_stat_nested$C) / sqrt(nrow(results_PPS_PRS_clin_surv$c_stat_nested)),2),
                                    "-",
                                    round(mean(results_PPS_PRS_clin_surv$c_stat_nested$C) + sd(results_PPS_PRS_clin_surv$c_stat_nested$C) / sqrt(nrow(results_PPS_PRS_clin_surv$c_stat_nested)),2),
                                    ")"),
                             paste0(round(mean(results_PPS_PRS_clin_surv$c_stat_nested$C),2), " (",
...
rf_rem_results <- data.frame(model=c("Clinical", "PPS", "PRS", "Clinical+PPS", "Clinical+PRS", "PPS+PRS", "All"),
                              C=c(paste0(round(mean(results_clin_surv$c_stat_nested$C),2), " (",
                                  ...
                                  paste0(round(mean(results_PPS_PRS_surv$c_stat_nested$C),2), " (",
                                         round(mean(results_PPS_PRS_surv$c_stat_nested$C) - sd(results_PPS_PRS_surv$c_stat_nested$C) / sqrt(nrow(results_PPS_PRS_surv$c_stat_nested)),2),
                                         "-",
                                         round(mean(results_PPS_PRS_surv$c_stat_nested$C) + sd(results_PPS_PRS_surv$c_stat_nested$C) / sqrt(nrow(results_PPS_PRS_surv$c_stat_nested)),2),
                                         ")"),
                                  paste0(round(mean(results_PPS_PRS_clin_surv$c_stat_nested$C),2), " (",
                              ...
                              BAC=c(paste0(round(mean(results_clin_surv$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                           round((mean(results_clin_surv$c_stat_nested$balanced_accuracy) - sd(results_clin_surv$results_clin_surv$balanced_accuracy) / sqrt(nrow(results_clin_surv$c_stat_nested)))*100,1),
                                           "%-",
                                           round((mean(results_clin_surv$c_stat_nested$balanced_accuracy) + sd(results_clin_surv$results_clin_surv$balanced_accuracy) / sqrt(nrow(results_clin_surv$c_stat_nested)))*100,1),
                                           "%)"),
                                    paste0(round(mean(results_PPS_surv$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                           round((mean(results_PPS_surv$c_stat_nested$balanced_accuracy) - sd(results_PPS_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS_surv$c_stat_nested)))*100,1),
                                           "%-",
                                           round((mean(results_PPS_surv$c_stat_nested$balanced_accuracy) + sd(results_PPS_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS_surv$c_stat_nested)))*100,1),
                                           "%)"),
                                    paste0(round(mean(results_PRS_surv$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                           round((mean(results_PRS_surv$c_stat_nested$balanced_accuracy) - sd(results_PRS_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PRS_surv$c_stat_nested)))*100,1),
                                           "%-",
                                           round((mean(results_PRS_surv$c_stat_nested$balanced_accuracy) + sd(results_PRS_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PRS_surv$c_stat_nested)))*100,1),
                                           "%)"),
                                    paste0(round(mean(results_PPS_clin_surv$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                           round((mean(results_PPS_clin_surv$c_stat_nested$balanced_accuracy) - sd(results_PPS_clin_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS_clin_surv$c_stat_nested)))*100,1),
                                           "%-",
                                           round((mean(results_PPS_clin_surv$c_stat_nested$balanced_accuracy) + sd(results_PPS_clin_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS_clin_surv$c_stat_nested)))*100,1),
                                           "%)"),
                                    paste0(round(mean(results_PRS_clin_surv$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                           round((mean(results_PRS_clin_surv$c_stat_nested$balanced_accuracy) - sd(results_PRS_clin_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PRS_clin_surv$c_stat_nested)))*100,1),
                                           "%-",
                                           round((mean(results_PRS_clin_surv$c_stat_nested$balanced_accuracy) + sd(results_PRS_clin_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PRS_clin_surv$c_stat_nested)))*100,1),
                                           "%)"),
                                    paste0(round(mean(results_PPS_PRS_surv$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                           round((mean(results_PPS_PRS_surv$c_stat_nested$balanced_accuracy) - sd(results_PPS_PRS_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS_PRS_surv$c_stat_nested)))*100,1),
                                           "%-",
                                           round((mean(results_PPS_PRS_surv$c_stat_nested$balanced_accuracy) + sd(results_PPS_PRS_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS_PRS_surv$c_stat_nested)))*100,1),
                                           "%)"),
                                    paste0(round(mean(results_PPS_PRS_clin_surv$c_stat_nested$balanced_accuracy)*100,1), "% (",
                                           round((mean(results_PPS_PRS_clin_surv$c_stat_nested$balanced_accuracy) - sd(results_PPS_PRS_clin_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS_PRS_clin_surv$c_stat_nested)))*100,1),
                                           "%-",
                                           round((mean(results_PPS_PRS_clin_surv$c_stat_nested$balanced_accuracy) + sd(results_PPS_PRS_clin_surv$c_stat_nested$balanced_accuracy) / sqrt(nrow(results_PPS_PRS_clin_surv$c_stat_nested)))*100,1),
                                           "%)")),
                              sensitivity=c(paste0(round(mean(results_clin_surv$c_stat_nested$sensitivity)*100,1), "% (",
                                                   round((mean(results_clin_surv$c_stat_nested$sensitivity) - sd(results_clin_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_clin_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_clin_surv$c_stat_nested$sensitivity) + sd(results_clin_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_clin_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PPS_surv$c_stat_nested$sensitivity)*100,1), "% (",
                                                   round((mean(results_PPS_surv$c_stat_nested$sensitivity) - sd(results_PPS_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PPS_surv$c_stat_nested$sensitivity) + sd(results_PPS_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PRS_surv$c_stat_nested$sensitivity)*100,1), "% (",
                                                   round((mean(results_PRS_surv$c_stat_nested$sensitivity) - sd(results_PRS_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PRS_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PRS_surv$c_stat_nested$sensitivity) + sd(results_PRS_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PRS_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PPS_clin_surv$c_stat_nested$sensitivity)*100,1), "% (",
                                                   round((mean(results_PPS_clin_surv$c_stat_nested$sensitivity) - sd(results_PPS_clin_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS_clin_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PPS_clin_surv$c_stat_nested$sensitivity) + sd(results_PPS_clin_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS_clin_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PRS_clin_surv$c_stat_nested$sensitivity)*100,1), "% (",
                                                   round((mean(results_PRS_clin_surv$c_stat_nested$sensitivity) - sd(results_PRS_clin_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PRS_clin_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PRS_clin_surv$c_stat_nested$sensitivity) + sd(results_PRS_clin_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PRS_clin_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PPS_PRS_surv$c_stat_nested$sensitivity)*100,1), "% (",
                                                   round((mean(results_PPS_PRS_surv$c_stat_nested$sensitivity) - sd(results_PPS_PRS_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS_PRS_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PPS_PRS_surv$c_stat_nested$sensitivity) + sd(results_PPS_PRS_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS_PRS_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PPS_PRS_clin_surv$c_stat_nested$sensitivity)*100,1), "% (",
                                                   round((mean(results_PPS_PRS_clin_surv$c_stat_nested$sensitivity) - sd(results_PPS_PRS_clin_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS_PRS_clin_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PPS_PRS_clin_surv$c_stat_nested$sensitivity) + sd(results_PPS_PRS_clin_surv$c_stat_nested$sensitivity) / sqrt(nrow(results_PPS_PRS_clin_surv$c_stat_nested)))*100,1),
                                                   "%)")),
                              specificity=c(paste0(round(mean(results_clin_surv$c_stat_nested$specificity)*100,1), "% (",
                                                   round((mean(results_clin_surv$c_stat_nested$specificity) - sd(results_clin_surv$c_stat_nested$specificity) / sqrt(nrow(results_clin_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_clin_surv$c_stat_nested$specificity) + sd(results_clin_surv$c_stat_nested$specificity) / sqrt(nrow(results_clin_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PPS_surv$c_stat_nested$specificity)*100,1), "% (",
                                                   round((mean(results_PPS_surv$c_stat_nested$specificity) - sd(results_PPS_surv$c_stat_nested$specificity) / sqrt(nrow(results_PPS_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PPS_surv$c_stat_nested$specificity) + sd(results_PPS_surv$c_stat_nested$specificity) / sqrt(nrow(results_PPS_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PRS_surv$c_stat_nested$specificity)*100,1), "% (",
                                                   round((mean(results_PRS_surv$c_stat_nested$specificity) - sd(results_PRS_surv$c_stat_nested$specificity) / sqrt(nrow(results_PRS_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PRS_surv$c_stat_nested$specificity) + sd(results_PRS_surv$c_stat_nested$specificity) / sqrt(nrow(results_PRS_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PPS_clin_surv$c_stat_nested$specificity)*100,1), "% (",
                                                   round((mean(results_PPS_clin_surv$c_stat_nested$specificity) - sd(results_PPS_clin_surv$c_stat_nested$specificity) / sqrt(nrow(results_PPS_clin_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PPS_clin_surv$c_stat_nested$specificity) + sd(results_PPS_clin_surv$c_stat_nested$specificity) / sqrt(nrow(results_PPS_clin_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PRS_clin_surv$c_stat_nested$specificity)*100,1), "% (",
                                                   round((mean(results_PRS_clin_surv$c_stat_nested$specificity) - sd(results_PRS_clin_surv$c_stat_nested$specificity) / sqrt(nrow(results_PRS_clin_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PRS_clin_surv$c_stat_nested$specificity) + sd(results_PRS_clin_surv$c_stat_nested$specificity) / sqrt(nrow(results_PRS_clin_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PPS_PRS_surv$c_stat_nested$specificity)*100,1), "% (",
                                                   round((mean(results_PPS_PRS_surv$c_stat_nested$specificity) - sd(results_PPS_PRS_surv$c_stat_nested$specificity) / sqrt(nrow(results_PPS_PRS_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PPS_PRS_surv$c_stat_nested$specificity) + sd(results_PPS_PRS_surv$c_stat_nested$specificity) / sqrt(nrow(results_PPS_PRS_surv$c_stat_nested)))*100,1),
                                                   "%)"),
                                            paste0(round(mean(results_PPS_PRS_clin_surv$c_stat_nested$specificity)*100,1), "% (",
                                                   round((mean(results_PPS_PRS_clin_surv$c_stat_nested$specificity) - sd(results_PPS_PRS_clin_surv$c_stat_nested$specificity) / sqrt(nrow(results_PPS_PRS_clin_surv$c_stat_nested)))*100,1),
                                                   "%-",
                                                   round((mean(results_PPS_PRS_clin_surv$c_stat_nested$specificity) + sd(results_PPS_PRS_clin_surv$c_stat_nested$specificity) / sqrt(nrow(results_PPS_PRS_clin_surv$c_stat_nested)))*100,1),
                                                   "%)")),
